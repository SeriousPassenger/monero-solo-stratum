...
curl() {
    ...
    case "$url" in
        ...
        */v1/shares/recent-high)
            body='{"data":[{"id":"4","actual_difficulty":"80000000000","worker_id":"1","round_id":"1","completed_at":"2026-08-13T08:01:02.000000Z"}]}'
            ;;
        *) return 95 ;;
    esac
...
grep -F 'Node      RPC healthy  ZMQ healthy  template gen 4' "$output" >/dev/null
...
grep -F '1. 80.0 G  2026-08-13 08:01:02 UTC  share #4  worker #1' "$output" >/dev/null
